...
import com.example.educationappsysproject.examsection.views.viewmodel.QuestionViewModel;
...
public class ResultFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull  View view, @Nullable  Bundle savedInstanceState) {
        ...
        quizId = ResultFragmentArgs.fromBundle(getArguments()).getExamId();

        viewModel.setExamId(quizId);

...
public class allCoursesSection extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_courses_section);
        userHomeName = findViewById(R.id.userHomeName);
            ...
            RecyclerView recyclerView = findViewById(R.id.coursesRecyclerViewAll);
